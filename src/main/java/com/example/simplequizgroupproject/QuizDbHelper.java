...
public class QuizDbHelper extends SQLiteOpenHelper {
    ...
    private void addQuestion(Question q1) {
        ...
        cv.put(QuestionsTable.COULUMN_QUESTION, q1.getQuestion());
        cv.put(QuestionsTable.COULUMN_OPTION1, q1.getOption1());
        cv.put(QuestionsTable.COULUMN_OPTION2, q1.getOption2());
        cv.put(QuestionsTable.COULUMN_OPTION3, q1.getOption3());
        cv.put(QuestionsTable.COULUMN_OPTION4, q1.getOption4());
        cv.put(QuestionsTable.COULUMN_ANSWER_NUM, q1.getAnswerNum());
        cv.put(QuestionsTable.COULUMN_EMPTY, q1.getAnswerEmpty());
